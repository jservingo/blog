  ...
  var template_post = '<div class="post pcard">'+
   '<div class="content-post">'+
  	'<div style="float:right;">'+
	      ...
	      '<div class="date truncate" data-height="51" style="width: 226px; padding: 10px 5px 5px 10px; background-color: rgb(215, 233, 243); height: 51px;">'+
		      '<a href=":source:" class="text-uppercase c-blue" data-id="1">'+
    ...
    '<div>'+
    	'<div class="truncate" data-height="128" style="width: 287px; background-color: rgb(254, 253, 253); padding: 10px 10px 4px; text-align: justify; height: 128px;">'+
        '<a href=":source:" class="t-excerpt c-negro" data-id="1">'+
          ':excerpt:'+
        '</a>'+
      '</div>'+
    '</div>'+	
