...
;(function($, window, document, undefined) {
	...
	if (!$('#ppq-audio-player-style').length) {
		var style = '<style id="ppq-audio-player-style" type="text/css">\
			...
			.ppq-audio-player .play-pause-btn .play-pause-icon{position:relative;display:block;width:37px;height:37px;border:3px solid #74ABC9;border-radius:100%;background-color:#fff}\
			...
			.ppq-audio-player .player-bar .player-bar-played{position:absolute;top:0;left:0;width:0;height:100%;border-radius:3px;background:#74ABC9}\
			</style>';
		$('body').prepend(style);
	}
