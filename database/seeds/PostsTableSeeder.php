...
class PostsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $post->published_at = Carbon::now('UTC')->subDays(10);
        $post->type_id = 1;
        $post->user_id = 1;
        $post->save();
        ...
        $post->published_at = Carbon::now('UTC')->subDays(9);
        $post->type_id = 2;
        $post->user_id = 1;
        $post->save();
        ...
        $post->body = "";
        $post->published_at = Carbon::now('UTC')->subDays(8);
        $post->type_id = 4;
        $post->user_id = 1;
        $post->save();
        ...
        $post->published_at = Carbon::now('UTC')->subDays(7);
        $post->type_id = 3;
        $post->user_id = 1;
        $post->save();
        ...
        $post->published_at = Carbon::now('UTC')->subDays(6);
        $post->type_id = 2;
        $post->user_id = 1;
        $post->save();
        ...
        $post->published_at = Carbon::now('UTC')->subDays(5);
        $post->type_id = 2;
        $post->user_id = 1;
        $post->save();
        $post->tags()->attach(3, array('user_id' => 2));
        ...
        $post->published_at = Carbon::now('UTC')->subDays(4);
        $post->type_id = 1;
        $post->user_id = 1;
        $post->save();
        ...
        $post->published_at = Carbon::now('UTC')->subDays(3);
        $post->type_id = 5;
        $post->user_id = 1;
        $post->save();
        ...
        $post->published_at = Carbon::now('UTC')->subDays(2);
        $post->type_id = 1;
        $post->user_id = 2;
        $post->save();
        ...
        $post->published_at = Carbon::now('UTC')->subDays(1);
        $post->type_id = 2;
        $post->user_id = 2;
        $post->save();
