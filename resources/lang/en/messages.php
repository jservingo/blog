<?php
	return[
		...
		'slogan' => 'Save, organize and share your posts',
		'solution' => 'Kodelia allows you to create and save posts created by other users. Organizing them in multiple catalogs, and pages to easily find the information posted. Share, send and receive post. Use powerfull aplications that access data comming from external sources.',
		'all-rights' => 'All Rights Reserved.',
		'd&d' => 'Designed & developed by Jorge Servín Gómez, JSG WEB SERVICES',
		'headquarters' => 'Caracas, Venezuela',
		'please-sign-up' => 'If you have not registered please sign up',
		...
		'feature-4' => 'Send and receive posts',
		...
		'received-empty' => 'You have not received posts.',
		'received-advice' => '',
		'notifications-empty' => 'You have not received notifications.',
		'notifications-advice' => '',
		'alerts-empty' => 'You have not received alerts.',
		'alerts-advice' => '',
		'sent-empty' => 'You have not sent posts.',
		'sent-advice' => '',
		'saved-empty' => 'You have not saved posts.',
		'saved-advice' => '',
		'discarded-empty' => 'You have not discarded posts.',
		'discarded-advice' => '',
		'created-apps-empty' => 'You have not created apps.',
		'created-apps-advice' => 'Sorry! This option is not implemented yet.',
		'created-pages-empty' => 'You have not created pages.',
		'created-pages-advice' => 'You can create a page by using the add button.',
		'created-catalogs-empty' => 'You have not created catalogs.',
		'created-catalogs-advice' => 'You can create a catalog by using the add button.',
		'created-posts-empty' => 'You have not created posts.',
		...
		'app_subscriptions-empty' => 'You have not subscribed to any app.',
		'app_subscriptions-advice' => 'You can subscribe to any app by discovering first.',
